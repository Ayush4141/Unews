...
import './zexamdetailscreen.dart';
import 'package:firebase_admob/firebase_admob.dart';


class ExamsItem extends StatefulWidget {
  @override
  _ExamsItemState createState() => _ExamsItemState();
}

class _ExamsItemState extends State<ExamsItem> {
  ...
  InterstitialAd createInterstitialAd() {
    return new InterstitialAd(
        adUnitId: "ca-app-pub-2319291998734234/8649161656",
