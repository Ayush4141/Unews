...
class SportsDetailScreen extends StatefulWidget {
  static const routeName = '/sportsnews-detail';

  @override
  _SportsDetailScreenState createState() => _SportsDetailScreenState();
}
...
class _SportsDetailScreenState extends State<SportsDetailScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final loadedProduct = Provider.of<NewsList>(context,listen: false,).findByIdinSports(newsId);
          ...
          child:Column(
            ...
            children: <Widget> [
              ...
              Container(
                ...
                Container(
                padding: EdgeInsets.only(left: 18 , right: 14),
                child: Text(loadedProduct.detail2 , style: TextStyle(fontSize: 17, letterSpacing: 1.0, height: 1.4),),
              ),
              SizedBox(height: 20),
              Container(
                  height: 10,
