...
class LifestyleDetailScreen extends StatefulWidget {
  static const routeName = '/lifenews-detail';

  @override
  _LifestyleDetailScreenState createState() => _LifestyleDetailScreenState();
}

class _LifestyleDetailScreenState extends State<LifestyleDetailScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final loadedProduct = Provider.of<NewsList>(context,listen: false,).findByIdinLifestyle(newsId);
