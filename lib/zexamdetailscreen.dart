...
class ExamsDetailScreen extends StatefulWidget {
  static const routeName = '/examssnews-detail';

  @override
  _ExamsDetailScreenState createState() => _ExamsDetailScreenState();
}
...
class _ExamsDetailScreenState extends State<ExamsDetailScreen> {
  ...
  Widget build(BuildContext context) {
    ...
    final loadedProduct = Provider.of<NewsList>(context,listen: false,).findByIdinExams(newsId);
